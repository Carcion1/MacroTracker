...
export const AboutComponent = (props: Props) => {
  return (
    ...
    <div className="AboutDetails">
      <h4>Hi, my name is Tom. 
      I am a software developer who has a hobby of going to the gym. I dedicated this project to help gym goers such as myself to help track their macros, calories & fitness related goals.
      I hope it can be of use to you as it is for me. Enjoy!</h4>
    </div>
</div>
    </div>
  )
